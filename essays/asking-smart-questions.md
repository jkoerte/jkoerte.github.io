...
The concept of smart questions need not apply only to Software Engineering. I think it is good practice for any question asker to show, if possible, that they at least tried to figure it out even if they are still completely lost. Even more important, is the necessity of clarity when asking your question. No matter what the topic of a question is on, neither the asker nor the responder benefits from a vague one. However, do not let the strict criteria of smart questions stop you from asking any questions at all. I suspect that your professors and classmates might have a bit more tolerance and patience than a random user on StackOverflow 
