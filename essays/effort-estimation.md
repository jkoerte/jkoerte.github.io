...
<img width="200px" class="rounded mb-1" src="../img/timerlogo.png">

## Introduction
Effort estimation involves predicting the amount of time, resources, and work required to complete a task. When compared with the actual effort required, it can lead to useful insights for project members, and better predictions for later tasks. Throughout our final project, my teammates and I underwent this process of effort estimation which provided several benefits to ourselves, and to our project.

## Estimating My Efforts
When making my estimates, they were based on my best guesses. I informed my estimate through how long it took me to do my assignments related to my current task, such as editing navbars, making style changes, and so on. Generally, I felt I was able to catch on to those kinds of assignments fairly quickly, so my estimates were a bit lower for things related to style. However, for most assignments I would often give myself a very high estimate on how long it would take (which would almost always end up being right) because I did not feel as though I was sufficiently knowledgeable enough. I applied the same principle for my tasks, especially for ones that I felt carried much more difficulty than others. For the tasks that required me to work with Prisma, for example, I was not so naive to think that it would take me only an hour to complete, especially because a lot of the aspects of that task were not covered in the assignments, such as getting user confirmation before deleting something, or trying to work with NextAuth user sessions to keep track of the currently logged-in user's id, name, etc.
...
## Conclusion
Overall, despite not having much experience with effort estimation, I was able to implement it in our final project quite decently, and experience the usefulness and benefits it brang.
